...
int main() {
    ...
    cout << "Ingrese el número de personas en la fila: ";
    cin >> n;
    ...
    for (int i = 0; i < n; i++) {
        ...
        cout << "Ingrese la vecindad de la persona " << i + 1 << ": ";
        getline(cin, vecindad);
        vecindades.push_back(vecindad);

        do {
            cout << "Ingrese la fecha de nacimiento de la persona " << i + 1 << " (dd mm aaaa): ";
            cin >> dia >> mes >> anio;
